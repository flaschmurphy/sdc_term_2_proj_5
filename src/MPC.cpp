...
// Define the most desirable values for cte, epsi and velocity
double ref_cte = 0;
double ref_epsi = 0;
double ref_v = 50;
...
// around in a circle with a constant steering angle and velocity on a flat
// terrain. Lf was tuned until the the radius formed by the simulating the model
// presented in the classroom matched the previous radius. This is the length
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    */
    ...
    for (unsigned int t = 0; t < N-1; t++) {
      ...
      // In the simulator the a positive value implies a right turn and
      // a negative value implies a left turn. Account for this by making 
      // the sign below negative instead of positive.
